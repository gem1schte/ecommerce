...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    if (
        ...
        $sql = "INSERT INTO products  (name,product_id ,description, price, stock_quantity, image_path) 
         VALUES (?, ?, ?, ?, ?, ?)";
        $stmt = $conn->prepare($sql);

        if ($stmt) {
            $stmt->bind_param("sssdss", $name, $product_id, $description, $price, $stock_quantity, $image_path);
