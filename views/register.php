                ...
                <div class="row">
                    <div class="col-12">
                        <div class="mb-5">
                            ...
                            <p class="text-center m-0"><span id="Register_Section_Title"></span> <a href="login.html" class="text-decoration-none">Sign in</a></p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12 col-lg-10 col-xl-8">
                        <div class="row gy-5 justify-content-center">
                            <div class="col-12 col-lg-5">
                                ...
                                <form class="form-horizontal was-validated" method="POST" action="register.php">
                                    ...
                                    <div class="row gy-3 overflow-hidden">
                                        ...
                                        <div class="form-check mb-3">
                                            ...
                                            I agree to the
                                            <a href="tos.html" class="clickable text-decoration-none">Terms of Service</a>.
                                        </div>
                            ...
                            <div class="col-12 col-lg-5 d-flex align-items-center">
                                <div class="d-flex gap-3 flex-column w-100 ">
                                    ...
                                    <a href="auth/oauth/google.php" class="btn btn-lg btn-danger" name="email">
