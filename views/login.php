    ...
    <section class="py-3 py-md-5 py-xl-8">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="mb-5">
                        <h2 class="display-5 fw-bold text-center"><?= __('Sign in') ?></h2>
                        <p class="text-center m-0"><?= __('Don\'t have an account?') ?> <a href="register.php" class="text-decoration-none"><?= __('Register') ?></a></p>
                    </div>
                </div>
            </div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="form-check">
                                                        <input
                                                            ...
                                                            name="remember"
                                                            value="Y">
                                                        <label for="remember" class="for-check-label"><?= __('Remember Me') ?></label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-6">
                                                <div class="text-end">
                                                    <a href="<?= WEBSITE_URL ."auth/forget_password.php" ?>"
                                                        class="link-secondary text-decoration-none"><?= __('Forgot password?') ?>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
